defmodule SmartSortWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SmartSortWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SmartSortWeb.Gettext, "errors", msg, opts)
    end
  end
